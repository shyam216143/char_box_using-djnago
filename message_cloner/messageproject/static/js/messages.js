...
function messageNew(message) {
   ...
   let mes_ele =` <div class="d-flex mb-4 replied">
   <div class="msg_cotainer_send">
       <h3>${message}</h3>
       <span class="msg_time_send">8:55, pm </span>
   </div>
   <div class="img_cont_msg">
      ...
      <i class="fas-thin fa fa fa-check-double" style="color:grey ; font-size:small;margin-left: -22px;margin-top: 22px;"></i>
   </div>
</div>`
